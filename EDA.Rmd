...
ggplot(data = melted_cormat, aes(x=X1, y=X2, fill=value)) + 
  geom_tile()
```
Since a regression model is out of scope for this research, the age group needs to be split in groups. A boxplot with the age as a group is made vs some of the physical properties. Then a point of interest is added with a line.
```{r}
...
```
The red line represents the age of 11 from where the growth seems to stagnate. With this in mind 2 groups are created, aged 1 through 10 months and 11 and above months.
...
```
The barplot shows that there are 2531 crabs under the age of 11 months and 1362 crabs 11 months or older. Most crabs are young (under 11 months) but the second group should be large enough for machine learning. 
